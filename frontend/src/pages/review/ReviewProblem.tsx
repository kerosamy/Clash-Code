...
export default function ReviewProblem() {
  ...
  const handleAIRequest = async () => {
    ...
    try {
      ...
      // Auto-expand the summary so the user sees the result immediately
              ...
              {loadingAI && (
                <div className="absolute inset-0 bg-slate-900/60 backdrop-blur-[2px] flex items-center justify-center z-10">
                  <div className="flex items-center gap-3">
                    <Sparkles className="text-orange animate-spin-slow" size={20} />
                    <span className="text-xs font-black uppercase tracking-widest text-orange">AI Analyzing Content...</span>
                  </div>
                </div>
              )}
